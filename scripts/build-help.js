...
/* ── Collapsible spoilers (<details>) inside article bodies ── */
.article-body details { border: 1px solid var(--border, #e4e7f1); border-radius: 12px; margin: 0 0 12px; background: #fff; }
.article-body details summary { cursor: pointer; padding: 15px 18px; font-weight: 700; font-size: 15px; list-style: none; display: flex; align-items: center; gap: 10px; color: var(--text, #0f1228); }
.article-body details summary::-webkit-details-marker { display: none; }
.article-body details summary::after { content: '\\f078'; font-family: 'Font Awesome 6 Free'; font-weight: 900; font-size: .72rem; color: #a0a6c4; margin-left: auto; transition: transform .2s; }
.article-body details[open] summary::after { transform: rotate(180deg); }
.article-body details[open] summary { border-bottom: 1px solid var(--border, #e4e7f1); }
.article-body details > p, .article-body details > ul, .article-body details > ol { padding: 14px 18px 0; margin: 0; }
