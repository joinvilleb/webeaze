...
(function () {
  ...
  window.__FIX_OVERRIDE = {
    ...
    update_requests: [
      ...
      { id: 'q2', user_id: UID, type: 'Content update', status: 'In progress', notes: 'Please update the hours on the contact page. We now open at 7am on Saturdays.', created_at: ago(1, 4), updated_at: ago(1, 3), seen_at: ago(1, 3) },
      { id: 'q3', user_id: UID, type: 'Bug or broken element', status: 'Done', notes: 'The contact form on mobile was cutting off the message box.', resolution: 'We fixed the message box on mobile. It now expands as you type on every screen size.', created_at: ago(17), updated_at: ago(16), completed_at: ago(16) },
